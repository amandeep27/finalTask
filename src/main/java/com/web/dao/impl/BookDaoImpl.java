...
public class BookDaoImpl implements BookDao {
	...
	private static final String BOOK_TYPE = "book_type_en";
	private static final String GET_AUTHOR_ID_FROM_NAME = "select ba_id from book_author_en where ba_name=?;";
	...
	public BookInfo getBookInfoObject(BookInfo bookInfo, String langType) throws DaoException {
		...
		try {
			...
			resultSet = null;
			preparedStmt = null;
			preparedStmt = connection.prepareStatement(GET_AUTHOR_ID_FROM_NAME);
