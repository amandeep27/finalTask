...
public class UserInfo implements Serializable {
	...
	private static final long serialVersionUID = 2720795257145775621L;
	private int userId;
	...
	public UserInfo(int userId, String userName, String password, String userRole, UserLanguage lang) {
		super();
		this.userId = userId;
