...
public class GetUserSignInInfo implements Command {
	...
	private static final String USERID_ERROR = "Wrong UserName!!";
	private static final String PASSWORD_ERROR = "Wrong Password for entered UserName!!";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
		...
		boolean validUser;
		signInInfo = new SignInInfo(request.getParameter(NAME), request.getParameter(PASSWORD));
		LOGGER.info(signInInfo);
...
LOGGER.info("valid user");
			...
			if (validUser != false) {
				userInfo = signInInfoService.getUserInfoByName(signInInfo);
				...
				if (validUser == false) {
					...
					httpSession.removeAttribute(EDIT_INFO_ERROR);
