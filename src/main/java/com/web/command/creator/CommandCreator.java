...
import com.web.command.impl.EditUserInfo;
...
import com.web.command.impl.GetPage;
...
public class CommandCreator {
	...
	private CommandCreator() {
		...
		commandCreator.put(GET_PAGE, new GetPage());
		commandCreator.put(EDIT_INFO, new EditUserInfo());
	}
